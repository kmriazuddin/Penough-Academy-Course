...
import Janny from '../assets/janny.jpg';
import Khairul from '../assets/khairul.jpg';
import Ashfaq from '../assets/ashfaq.jpg';
...
const Instructor = () => {
  const instructors = [
    ...
    },
    {
      ...
      skills: ["Mobile Application Security", "Vulnerability Assessment and Penetration Testing(VAPT)", "Exploit Development", "Red Team Operations", "Web Application Security", "Network Penetration", "Social Engineering"],
    ...
    <div className={`instructor-card ${isFlipped ? 'flipped' : ''}`}>
      <div className="card-inner ">
        <div className="card-front bg-gray-50 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <img className="w-full h-72 object-cover rounded-t-lg" src={image} alt={`${name} Avatar`} />
          <div className="p-5">
            <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
              {name}
            </h3>
            <span className="text-gray-500 dark:text-gray-400">{title}</span>
            <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400 text-justify tracking-tight">{description}</p>
