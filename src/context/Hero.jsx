...
import courseImage2 from '../assets/DCS_102.png';
      ...
      >
        ...
        <div className="relative z-10 p-6 mx-auto">
          ...
          <p className="text-lg md:text-xl max-w-6xl mb-6 text-balance">
            Welcome to Penough Academy, the leading institution for Defensive cyber security training.
            Our academy is dedicated to developing skilled professionals in defensive cyber security,
            specializing in protecting digital assets, securing networks, and responding to cyber threats.
            With a curriculum that emphasizes practical, hands-on learning and expert-led instruction,
            Penough Academy equips students with the knowledge and skills needed to excel in Defensive operations.
          </p>
        </div>
      </div>
